...
class PostgreSQLIdentityKernel(PostgreSQLBaseKernel):
    ...
    async def get_user_by_id(self, user_id: str, tenant_id: str = None) -> Optional[Dict[str, Any]]:
        """Get user by ID"""
        try:
            if tenant_id:
                await self.set_tenant_context(tenant_id)
    ...
    async def authenticate_user(self, tenant_subdomain: str, email: str, password: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # Update last login
            await self.update_record(User, user.id, {"last_login": datetime.utcnow()}, str(tenant.id))
    ...
    async def update_user(self, tenant_id: str, user_id: str, updates: Dict[str, Any]) -> bool:
    ...
    async def change_password(self, tenant_id: str, user_id: str, new_password: str) -> bool:
        ...
        try:
            ...
            if password_record:
                await self.update_record(UserPassword, password_record.id, {
                    "hashed_password": hashed_password,
    ...
    async def check_user_permission(self, tenant_id: str, user_id: str, permission: str) -> bool:
        ...
        try:
            ...
            role_permissions = {
                ...
                "administrator": ["user.create", "user.update", "page.create", "page.update", "page.delete", "lead.manage"],
                "property_manager": ["page.create", "page.update", "lead.manage", "booking.manage"],
    ...
    async def list_users(self, tenant_id: str, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[Dict[str, Any]]:
