...
async def list_workflows(
    ...
    try:
        workflows = await comm_kernel.get_workflows(
            tenant_id, 
            trigger_event.value if trigger_event else None
        )
...
async def send_message(
    ...
    try:
        # Render template
        rendered = await comm_kernel.render_template(request.template_id, request.context)
...
async def get_communication_stats(
    ...
    try:
        ...
        stats = await comm_kernel.get_communication_stats(tenant_id, start_date, end_date)
