...
class PerformanceMonitor:
    ...
    async def get_tenant_performance(
        self, tenant_id: str, hours: int = 1
    ) -> Dict[str, Any]:
        ...
        response_times = [
            m.value for m in tenant_metrics if m.metric_type == "response_time"
        ]
        db_queries = [
            m.value for m in tenant_metrics if m.metric_type == "database_query"
        ]
