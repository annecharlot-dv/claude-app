...
class LineItem(Base):
    ...
    # Indexes
    __table_args__ = (Index("idx_line_items_invoice", "invoice_id"),)
...
class MessageTemplate(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "idx_message_templates_config_gin",
            "template_config",
            postgresql_using="gin",
        ),
    )
...
class MessageQueue(Base):
    ...
    template_id = Column(
        UUID(as_uuid=True), ForeignKey("message_templates.id"), index=True
    )
...
class AutomationLog(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "idx_automation_logs_details_gin",
            "execution_details",
            postgresql_using="gin",
        ),
    )
